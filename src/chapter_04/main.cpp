...
template<typename T, typename U>
void process09(transaction_t(T::*)(U)) { std::cout << "C (T::*)(U)" << '\n'; }

template<typename T>
void process09(balance_report_t(balance_t::*)(T)) { std::cout << "D (C::*)(T)" << '\n'; }

template<typename T>
void process10(T account_t::*) { std::cout << "T C::*" << '\n'; }

template<typename T>
void process10(account_t T::*) { std::cout << "C T::*" << '\n'; }
